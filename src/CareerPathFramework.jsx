      ...
      frontend: {
        ...
        levels: {
          ...
          IC3: {
            ...
            technicalSkills: [
              "Proficient in React.js and Next.js for building performant web applications",
              "Strong TypeScript skills — writes type-safe, maintainable code by default",
              "Experience with GraphQL for efficient data fetching and state management",
              "Understands web performance fundamentals (Core Web Vitals, lazy loading, code splitting)",
              "Familiarity with WebSockets for real-time communication features",
              "Working knowledge of testing frameworks (Jest, React Testing Library, Cypress)",
              "Can translate complex Figma designs into pixel-perfect, accessible interfaces",
            ],
            deliveryAndImpact: [
              "Independently owns and delivers medium-sized features from spec to deployment",
              "Identifies and resolves performance bottlenecks in frontend applications",
              "Writes clean, well-tested code and provides constructive code reviews",
              "Contributes to sprint planning with accurate estimations",
              "Moderate impact on team velocity and product quality",
            ],
            collaboration: [
              "Collaborates effectively with backend engineers, designers, and product managers",
              "Communicates technical trade-offs clearly to non-technical stakeholders",
              "Helps onboard new team members by sharing context and best practices",
            ],
            growthMindset: [
              "Stays current with frontend ecosystem trends (frameworks, tooling, browser APIs)",
              "Proactively improves existing code quality and developer experience",
              "Seeks ownership of larger features and cross-cutting concerns",
            ],
          },
          IC4: {
            ...
            technicalSkills: [
              "Mastery of React.js, Next.js, and modern frontend architecture patterns",
              "Deep proficiency in TypeScript — designs type systems and shared libraries",
              "Expert in GraphQL schema design and client-side caching strategies",
              "Advanced performance optimization — diagnoses complex bottlenecks, optimizes large-scale applications for speed and responsiveness",
              "Experience with WebSockets, real-time data, and complex state management at scale",
              "Strong grasp of CI/CD pipelines, automated testing strategies, and deployment workflows",
              "Understands accessibility (WCAG) and internationalization at a systems level",
            ],
            deliveryAndImpact: [
              "Owns and delivers complex, cross-cutting features with minimal guidance",
              "Architects frontend solutions for new products and major rewrites",
              "Sets and enforces code quality standards — the team's go-to for frontend decisions",
              "Drives measurable improvements in performance, reliability, and developer productivity",
              "Moderate to significant impact on product success and team output",
            ],
            collaboration: [
              "Mentors junior and mid-level engineers — structured feedback, pair programming, growth plans",
              "Bridges technical and non-technical stakeholders effectively",
              "Plays a key role in structuring the frontend team and fostering collaborative culture",
              "Drives architectural discussions and influences technical direction",
            ],
            growthMindset: [
              "Self-starter with strong ownership mindset — full accountability for the frontend stack",
              "\"Move Fast\" mentality: prioritizes developer productivity at an accelerated pace",
              "Focus on Impact — ensures work directly contributes to business decisions",
              "Creative and solution-driven, navigating tough challenges with ease",
            ],
          },
          IC5: {
            ...
            technicalSkills: [
              "Deep, hands-on expertise with React.js and Next.js — builds and refactors scalable architectures from the ground up",
              "Profound proficiency in TypeScript, GraphQL, and WebSockets for robust, real-time systems",
              "Proven track record diagnosing and solving complex performance bottlenecks at scale",
              "Drives frontend platform decisions — shared component libraries, design systems, build tooling",
              "Expert in cross-platform considerations (responsive, PWA, mobile-web)",
              "Deep understanding of security, caching, and edge computing patterns for frontend",
            ],
            deliveryAndImpact: [
              "Reimagines, rebuilds, and optimizes codebases for unmatched scalability and innovation",
              ...
              "Directly impacts company-wide results through technical excellence and product strategy",
              "Champions performance and quality — every millisecond and byte matters",
            ],
            collaboration: [
              "Structures, mentors, and onboards engineers — fosters a culture of high standards and continuous learning",
              "Partners with product, design, and leadership to align technical direction with business goals",
              "Drives cross-team initiatives and architectural alignment across multiple products",
              "Recognised as the engineering authority for frontend across the company",
            ],
            growthMindset: [
              "Relentless dedication — thrives in demanding, fast-paced environments with uncompromising quality",
              "Curious and impact-obsessed — product thinker pushing boundaries with breakthrough innovations",
              "Obsessed with engineering excellence — deeply hands-on, driven to rebuild and optimize",
              "Influences industry-level thinking and brings external best practices into the org",
            ],
          },
          IC6: {
      ...
      backend: {
        ...
        levels: {
          ...
          IC3: {
            ...
            technicalSkills: [
              "Strong proficiency in Node.js/TypeScript and/or Python (FastAPI)",
              "Solid experience with relational databases (PostgreSQL) and NoSQL (MongoDB, Redis)",
              "Designs and implements RESTful and/or GraphQL APIs with proper error handling and validation",
              "Working knowledge of message queues, event-driven architectures, and caching strategies",
              "Experience with Docker, basic Kubernetes, and CI/CD pipeline configuration",
              "Understanding of monitoring, logging, and observability fundamentals (e.g., Datadog, Grafana)",
              "Familiarity with cloud platforms (AWS or GCP) — can deploy and configure basic services",
            ],
            deliveryAndImpact: [
              "Owns services end-to-end — from schema and API design to deployment and monitoring",
              ...
              "Moderate impact on service reliability and team velocity",
            ],
            collaboration: [
              "Works effectively with frontend engineers, data teams, and product managers",
              "Participates in architectural discussions with informed opinions",
              "Contributes to documentation and helps onboard new team members",
            ],
            growthMindset: [
              "Proactively improves code quality, test coverage, and development workflows",
              "Stays current with backend ecosystem developments and best practices",
              "Seeks ownership of larger services and cross-cutting infrastructure concerns",
            ],
          },
          IC4: {
            ...
            technicalSkills: [
              "Expert in Node.js/TypeScript and Python — designs services for high-traffic, scalable systems",
              "Deep knowledge of database design, indexing, query optimization, and data modeling",
              "Experience with microservices architecture, API gateway patterns, and service mesh",
              "Proficient with cloud infrastructure (AWS/GCP) — IaC tools like Terraform, containers, orchestration",
              "Advanced understanding of caching, rate limiting, connection pooling, and performance tuning",
              "Experience with BigQuery, data warehouse design, and analytics pipelines",
              "Strong observability practice — drives monitoring, alerting, and SLO/SLI definition",
            ],
            deliveryAndImpact: [
              "Architects and delivers complex backend systems with minimal guidance",
              ...
              "Moderate to significant impact on platform reliability and engineering output",
            ],
            collaboration: [
              "Mentors junior and mid-level engineers — guides technical growth and career development",
              "Leads architectural discussions and drives consensus on technical direction",
              "Partners with product and data teams to translate business needs into technical solutions",
              "Solid engineering discipline — CI/CD, testing, microservices, end-to-end ownership",
            ],
            growthMindset: [
              "Highly technical mindset with a drive to improve daily",
              "Product-minded — cares about impact, not just code",
              "Comfortable with ambiguity, fast decisions, and a high bar for quality",
              "Solution-driven — thrives in fast-paced, non-9-to-5 startup culture",
            ],
          },
          IC5: {
            ...
            collaboration: [
              "Provides technical leadership across teams — drives alignment on platform direction",
            ...
            growthMindset: [
              "High-ownership builder with intense intrinsic motivation",
              "AI-enabled mindset — deep expertise deploying automation to focus on architecture and deep technical topics",
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dept-tab:hover { border-color: var(--border-hover); color: var(--text); }
        .dept-tab.active { background: var(--accent); border-color: var(--accent); color: white; }
        .role-chip {
          padding: 8px 16px;
          border-radius: 8px;
          border: 1px solid var(--border);
        ...
        .role-chip.active { background: var(--surface2); border-color: var(--text-dim); color: var(--text); }
        .level-btn {
          flex: 1;
          min-width: 0;
          padding: 12px 8px;
        ...
        .level-btn:hover { border-color: var(--border-hover); color: var(--text); transform: translateY(-1px); }
        .level-btn.active {
          border-color: currentColor;
          color: var(--text);
          background: var(--surface2);
          box-shadow: 0 0 20px rgba(232,85,58,0.08);
        }
        .level-btn .code { font-family: 'JetBrains Mono', monospace; font-size: 14px; font-weight: 600; display: block; }
        .level-btn .label { font-size: 10px; opacity: 0.6; margin-top: 2px; text-transform: uppercase; letter-spacing: 0.5px; }
        .section-header {
          display: flex;
          align-items: center;
          gap: 10px;
        ...
        .comparison-dot.filled {
          border-color: transparent;
        }
        @media (max-width: 600px) {
          .level-btn { padding: 10px 4px; }
          .level-btn .code { font-size: 12px; }
          .level-btn .label { font-size: 9px; }
        }
      `}</style>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 24px 48px" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontWeight: 600, color: "var(--text-muted)" }}>{levelData.yoe}</div>
            <div style={{ fontSize: 10, marginTop: 1 }}>typical exp.</div>
          </div>
        </div>
